      ...
      <div className="flex items-center gap-3">
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="w-9 h-9 flex items-center justify-center rounded-lg text-oe-muted hover:text-oe-text hover:bg-slate-100 transition-colors relative"
          >
            <Bell size={18} />
          ...
          {notifOpen && (
            <div className="absolute right-0 mt-1 w-80 bg-white border border-oe-border rounded-xl shadow-lg z-50 overflow-hidden">
